    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if (getCallbackQueryButtonKey().equals("step_1_btn")){
            ...
            sendTextMessageAsync(STEP_2_TEXT,
                    Map.of("¡Tomar una salchicha! +20 de fama\n","step_2_btn",
                            "¡Tomar un pescado! +20 de fama\n","step_2_btn",
        ...
        if (getCallbackQueryButtonKey().equals("step_2_btn")) {
            ...
            sendTextMessageAsync(STEP_3_TEXT,
                    Map.of("al robot aspirador", "step_3_btn")
            );
        }
        ...
        if (getCallbackQueryButtonKey().equals("step_3_btn")) {
            ...
            sendTextMessageAsync(STEP_4_TEXT,
                    Map.of("Enviar al robot aspirador a por comida! +30 de fama\n", "step_4_btn",
                            "Dar un paseo en el robot aspirador! +30 de fama\n","step_4_btn",
        ...
        if (getCallbackQueryButtonKey().equals("step_5_btn")) {
            ...
            sendTextMessageAsync(STEP_6_TEXT,
                    Map.of("¡Correr por los tejados, grabar con la GoPro! +40 de fama\n", "step_6_btn",
